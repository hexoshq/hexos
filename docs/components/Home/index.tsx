...
export const Home = () => {
  return (
    ...
    >
      ...
      <header className="max-w-[840px] grid gap-2.5">
        ...
        <h1
          className={[
            ...
            "max-[767px]:text-[clamp(38px,11vw,60px)] max-[767px]:leading-[0.98]",
          ].join(" ")}
        >
        ...
        <p
          className={[
            "m-0 max-w-[640px] leading-[1.38] text-[#626774]",
            "text-[clamp(16px,1.45vw,28px)]",
            "dark:text-[#d8e2f8]",
            "[html.dark_&]:text-[#d8e2f8]",
            "[html[data-theme=dark]_&]:text-[#d8e2f8]",
            "max-[767px]:text-base max-[767px]:leading-normal",
          ].join(" ")}
        >
          Central orchestrator for multi-agent conversations with LLM providers,
          tool execution, and human-in-the-loop approvals.
        </p>
      </header>

      <div className="flex justify-center items-center flex-wrap gap-3 max-[767px]:w-full">
        <Link
          href="/docs"
          className="inline-flex max-[767px]:flex-auto max-[767px]:justify-center"
        >
  ...
  <span className="select-none text-[#6a7388] dark:text-[#9db0dc] [html.dark_&]:text-[#9db0dc] [html[data-theme=dark]_&]:text-[#9db0dc]">~ </span>
  npx @hexos/create my-chat
</pre>

      <div className="w-full max-w-[1080px] flex flex-col items-center mt-1 text-center">
        <div
          className={[
        ...
        >
          ...
          >
            ...
            <div
              className={[
                "justify-self-center rounded-full px-3 py-1",
                "border border-[#dce0ea] bg-white",
                "text-xs text-[#677083] leading-none",
          ...
          <iframe
            ...
            className={[
              ...
              "max-[767px]:h-[380px] max-[767px]:min-h-[280px]",
            ].join(" ")}
            title="Hexos demo"
            loading="lazy"
          />
