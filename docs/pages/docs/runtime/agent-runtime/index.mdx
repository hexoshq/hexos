...
<GenerationInfo sourceFile="packages/runtime/src/AgentRuntime.ts" sourceLine="121" packageName="@hexos/runtime" />
...
class AgentRuntime {
    ...
    stream(input: RuntimeInput) => AsyncGenerator<RuntimeEventWithCategory>;
    invoke(input: RuntimeInput) => Promise<RuntimeOutput>;
    resumeWithApproval(conversationId: string, approvals: ApprovalDecision[]) => AsyncGenerator<RuntimeEventWithCategory>;
...
<MemberInfo kind="method" type={`(input: <a href='/docs/common/runtime/runtime-input#runtimeinput'>RuntimeInput</a>) => AsyncGenerator<RuntimeEventWithCategory>`} />
...
<MemberInfo kind="method" type={`(conversationId: string, approvals: <a href='/docs/react-core/tools/approval-decision#approvaldecision'>ApprovalDecision</a>[]) => AsyncGenerator<RuntimeEventWithCategory>`} />
